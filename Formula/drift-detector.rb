class DriftDetector < Formula
  ...
  url "https://github.com/yellowstonesoftware/drift-detector/archive/refs/tags/v0.0.6.tar.gz"
  sha256 "f6a9b17ed4ed615651e1e94e667df04f950e1998dc623fbd38b35bac8cff9f07"
  license "GPL-3.0-or-later"

  on_macos do
    on_arm do
      url "https://github.com/yellowstonesoftware/drift-detector/releases/download/v0.0.6/drift_detector_macos_arm64-v0.0.6.zip"
  ...
  on_linux do
    on_intel do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/yellowstonesoftware/drift-detector/releases/download/v0.0.6/drift_detector_linux-v0.0.6.zip"
